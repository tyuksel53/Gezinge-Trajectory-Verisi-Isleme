...
namespace Web_Api
{
    public class VeriIndirge
    {
        ...
        public static List<Coordinates> DouglasPeuckerReduction
            (List<Coordinates> Points, Double Tolerance)
        {
        ...
        private static void DouglasPeuckerReduction(List<Coordinates>
        ...
        public static Double PerpendicularDistance
            (Coordinates Point1, Coordinates Point2, Coordinates Point)
        {
            ...
            Double area = Math.Abs(.5 * (Point1.lat * Point2.lng + Point2.lat *
                                         ...
                                         Point2.lng - Point1.lng * Point.lng));
